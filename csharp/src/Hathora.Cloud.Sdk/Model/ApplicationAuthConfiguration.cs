...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Application_authConfiguration")]
    public partial class ApplicationAuthConfiguration : IEquatable<ApplicationAuthConfiguration>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAuthConfiguration" /> class.
        /// </summary>
        ...
        public ApplicationAuthConfiguration(ApplicationAuthConfigurationGoogle google = default(ApplicationAuthConfigurationGoogle), Object nickname = default(Object), Object anonymous = default(Object))
        {
            this.Google = google;
        ...
        {
            return this.Equals(input as ApplicationAuthConfiguration);
        }

        /// <summary>
        /// Returns true if ApplicationAuthConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAuthConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAuthConfiguration input)
        {
            if (input == null)
            {
                return false;
