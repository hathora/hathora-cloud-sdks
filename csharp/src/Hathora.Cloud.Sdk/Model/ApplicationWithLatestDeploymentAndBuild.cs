...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationWithLatestDeploymentAndBuild")]
    public partial class ApplicationWithLatestDeploymentAndBuild : IEquatable<ApplicationWithLatestDeploymentAndBuild>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationWithLatestDeploymentAndBuild" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationWithLatestDeploymentAndBuild()
        {
        ...
        public ApplicationWithLatestDeploymentAndBuild(string deletedBy = default(string), DateTime? deletedAt = default(DateTime?), DateTime createdAt = default(DateTime), string createdBy = default(string), string orgId = default(string), AuthConfiguration authConfiguration = default(AuthConfiguration), string appSecret = default(string), string appId = default(string), string appName = default(string), ApplicationWithLatestDeploymentAndBuildAllOfDeployment deployment = default(ApplicationWithLatestDeploymentAndBuildAllOfDeployment))
        {
            // to ensure "deletedBy" is required (not null)
            if (deletedBy == null)
            {
                throw new ArgumentNullException("deletedBy is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.DeletedBy = deletedBy;
            // to ensure "deletedAt" is required (not null)
            if (deletedAt == null)
            {
                throw new ArgumentNullException("deletedAt is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.CreatedBy = createdBy;
            // to ensure "orgId" is required (not null)
            if (orgId == null)
            {
                throw new ArgumentNullException("orgId is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.OrgId = orgId;
            // to ensure "authConfiguration" is required (not null)
            if (authConfiguration == null)
            {
                throw new ArgumentNullException("authConfiguration is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.AuthConfiguration = authConfiguration;
            // to ensure "appSecret" is required (not null)
            if (appSecret == null)
            {
                throw new ArgumentNullException("appSecret is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.AppSecret = appSecret;
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
            this.AppId = appId;
            // to ensure "appName" is required (not null)
            if (appName == null)
            {
                throw new ArgumentNullException("appName is a required property for ApplicationWithLatestDeploymentAndBuild and cannot be null");
            }
        ...
        {
            return this.Equals(input as ApplicationWithLatestDeploymentAndBuild);
        }

        /// <summary>
        /// Returns true if ApplicationWithLatestDeploymentAndBuild instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationWithLatestDeploymentAndBuild to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationWithLatestDeploymentAndBuild input)
        {
            if (input == null)
            {
                return false;
