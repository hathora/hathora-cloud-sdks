...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// CreateRoomParams
    /// </summary>
    [DataContract(Name = "CreateRoomParams")]
    public partial class CreateRoomParams : IEquatable<CreateRoomParams>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRoomParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRoomParams()
        {
        ...
        public CreateRoomParams(string roomConfig = default(string), Region region = default(Region))
        {
            this.Region = region;
        ...
        {
            return this.Equals(input as CreateRoomParams);
        }

        /// <summary>
        /// Returns true if CreateRoomParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRoomParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRoomParams input)
        {
            if (input == null)
            {
                return false;
