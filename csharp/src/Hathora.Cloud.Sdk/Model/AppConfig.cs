...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    public partial class AppConfig : IEquatable<AppConfig>
    {
        /// <summary>
        ...
        public AppConfig(AppConfigAuthConfiguration authConfiguration = default(AppConfigAuthConfiguration), string appName = default(string))
        {
            ...
            {
                throw new ArgumentNullException("authConfiguration is a required property for AppConfig and cannot be null");
            }
            this.AuthConfiguration = authConfiguration;
            // to ensure "appName" is required (not null)
            if (appName == null)
            {
                throw new ArgumentNullException("appName is a required property for AppConfig and cannot be null");
            }
