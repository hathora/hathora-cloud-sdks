...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// CreateLobbyParams
    /// </summary>
    [DataContract(Name = "CreateLobbyParams")]
    public partial class CreateLobbyParams : IEquatable<CreateLobbyParams>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLobbyParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLobbyParams()
        {
        ...
        public CreateLobbyParams(LobbyVisibility visibility = default(LobbyVisibility), Object initialConfig = default(Object), Region region = default(Region))
        {
            this.Visibility = visibility;
            // to ensure "initialConfig" is required (not null)
            if (initialConfig == null)
            {
                throw new ArgumentNullException("initialConfig is a required property for CreateLobbyParams and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateLobbyParams);
        }

        /// <summary>
        /// Returns true if CreateLobbyParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateLobbyParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateLobbyParams input)
        {
            if (input == null)
            {
                return false;
