...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppConfig_authConfiguration")]
    public partial class AppConfigAuthConfiguration : IEquatable<AppConfigAuthConfiguration>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppConfigAuthConfiguration" /> class.
        /// </summary>
        ...
        public AppConfigAuthConfiguration(ApplicationAuthConfigurationGoogle google = default(ApplicationAuthConfigurationGoogle), Object nickname = default(Object), Object anonymous = default(Object))
        {
            this.Google = google;
        ...
        {
            return this.Equals(input as AppConfigAuthConfiguration);
        }

        /// <summary>
        /// Returns true if AppConfigAuthConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of AppConfigAuthConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppConfigAuthConfiguration input)
        {
            if (input == null)
            {
                return false;
