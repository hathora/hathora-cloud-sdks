...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    public partial class ApplicationWithLatestDeploymentAndBuildAllOfDeployment : IEquatable<ApplicationWithLatestDeploymentAndBuildAllOfDeployment>
    {
        ...
        protected ApplicationWithLatestDeploymentAndBuildAllOfDeployment()
        {
        ...
        public ApplicationWithLatestDeploymentAndBuildAllOfDeployment(bool idleTimeoutEnabled = true, List<DeploymentEnvInner> env = default(List<DeploymentEnvInner>), int roomsPerProcess = default(int), PlanName planName = default(PlanName), List<ContainerPort> additionalContainerPorts = default(List<ContainerPort>), ContainerPort defaultContainerPort = default(ContainerPort), TransportTypeEnum transportType = default(TransportTypeEnum), double containerPort = default(double), DateTime createdAt = default(DateTime), string createdBy = default(string), int requestedMemoryMB = default(int), double requestedCPU = default(double), int deploymentId = default(int), int buildId = default(int), string appId = default(string), Build build = default(Build))
        {
            ...
            if (env == null)
            {
                throw new ArgumentNullException("env is a required property for ApplicationWithLatestDeploymentAndBuildAllOfDeployment and cannot be null");
            }
            this.Env = env;
            ...
            {
                throw new ArgumentNullException("additionalContainerPorts is a required property for ApplicationWithLatestDeploymentAndBuildAllOfDeployment and cannot be null");
            }
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for ApplicationWithLatestDeploymentAndBuildAllOfDeployment and cannot be null");
            }
            ...
            if (appId == null)
            {
                throw new ArgumentNullException("appId is a required property for ApplicationWithLatestDeploymentAndBuildAllOfDeployment and cannot be null");
            }
            this.AppId = appId;
        ...
        {
            return this.Equals(input as ApplicationWithLatestDeploymentAndBuildAllOfDeployment);
        }

        /// <summary>
        /// Returns true if ApplicationWithLatestDeploymentAndBuildAllOfDeployment instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationWithLatestDeploymentAndBuildAllOfDeployment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationWithLatestDeploymentAndBuildAllOfDeployment input)
        {
            if (input == null)
            {
                return false;
