...
namespace Hathora.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthConfiguration")]
    public partial class AuthConfiguration : IEquatable<AuthConfiguration>
    {
        /// <summary>
        ...
        public AuthConfiguration(AuthConfigurationGoogle google = default(AuthConfigurationGoogle), Object nickname = default(Object), Object anonymous = default(Object))
        {
            this.Google = google;
        ...
        {
            return this.Equals(input as AuthConfiguration);
        }

        /// <summary>
        /// Returns true if AuthConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfiguration input)
        {
            if (input == null)
            {
                return false;
