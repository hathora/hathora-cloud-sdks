...
namespace Hathora.Cloud.Sdk.Api
{
    ...
    public interface IMetricsV1ApiSync : IApiAccessor
    {
        ...
        /// <param name="metrics">Available metrics to query over time. (optional)</param>
        /// <param name="end">Unix timestamp. Default is current time. (optional)</param>
        /// <param name="start">Unix timestamp. Default is -1 hour from &#x60;end&#x60;. (optional)</param>
        /// <param name="step"> (optional)</param>
        /// <returns>RecordPartialMetricNameMetricValueArray</returns>
        RecordPartialMetricNameMetricValueArray GetMetrics(string appId, string processId, List<MetricName> metrics = default(List<MetricName>), double? end = default(double?), double? start = default(double?), int? step = default(int?));
        ...
        ApiResponse<RecordPartialMetricNameMetricValueArray> GetMetricsWithHttpInfo(string appId, string processId, List<MetricName> metrics = default(List<MetricName>), double? end = default(double?), double? start = default(double?), int? step = default(int?));
    ...
    public interface IMetricsV1ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<RecordPartialMetricNameMetricValueArray> GetMetricsAsync(string appId, string processId, List<MetricName> metrics = default(List<MetricName>), double? end = default(double?), double? start = default(double?), int? step = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MetricsV1Api : IDisposable, IMetricsV1Api
    {
        ...
        /// <param name="step"> (optional)</param>
        /// <returns>RecordPartialMetricNameMetricValueArray</returns>
        public RecordPartialMetricNameMetricValueArray GetMetrics(string appId, string processId, List<MetricName> metrics = default(List<MetricName>), double? end = default(double?), double? start = default(double?), int? step = default(int?))
        {
        ...
        /// <param name="step"> (optional)</param>
        /// <returns>ApiResponse of RecordPartialMetricNameMetricValueArray</returns>
        public Hathora.Cloud.Sdk.Client.ApiResponse<RecordPartialMetricNameMetricValueArray> GetMetricsWithHttpInfo(string appId, string processId, List<MetricName> metrics = default(List<MetricName>), double? end = default(double?), double? start = default(double?), int? step = default(int?))
        {
