...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.hathora.client.model.CreateRoomDeprecatedRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.hathora.client.model.DeploymentEnvInner.CustomTypeAdapterFactory());
