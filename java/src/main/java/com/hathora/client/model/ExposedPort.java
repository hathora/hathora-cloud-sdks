...
public class ExposedPort {
  ...
  **/
  ...
  public ExposedPort port(Double port) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ExposedPort
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExposedPort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
