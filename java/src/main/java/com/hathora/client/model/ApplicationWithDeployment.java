...
public class ApplicationWithDeployment {
  ...
  public ApplicationWithDeployment deletedBy(String deletedBy) {
  ...
  **/
  ...
  public ApplicationWithDeployment deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ApplicationWithDeployment createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ApplicationWithDeployment createdBy(String createdBy) {
  ...
  **/
  ...
  public ApplicationWithDeployment orgId(String orgId) {
  ...
  **/
  ...
  public ApplicationWithDeployment authConfiguration(AuthConfiguration authConfiguration) {
  ...
  **/
  ...
  public ApplicationWithDeployment appSecret(String appSecret) {
  ...
  **/
  ...
  public ApplicationWithDeployment appId(String appId) {
  ...
  **/
  ...
  public ApplicationWithDeployment appName(String appName) {
  ...
  **/
  ...
  public ApplicationWithDeployment deployment(Deployment deployment) {
  ...
  **/
   ...
   * @return the ApplicationWithDeployment instance itself
   */
  public ApplicationWithDeployment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationWithDeployment applicationWithDeployment = (ApplicationWithDeployment) o;
    return Objects.equals(this.deletedBy, applicationWithDeployment.deletedBy) &&
        Objects.equals(this.deletedAt, applicationWithDeployment.deletedAt) &&
        Objects.equals(this.createdAt, applicationWithDeployment.createdAt) &&
        Objects.equals(this.createdBy, applicationWithDeployment.createdBy) &&
        Objects.equals(this.orgId, applicationWithDeployment.orgId) &&
        Objects.equals(this.authConfiguration, applicationWithDeployment.authConfiguration) &&
        Objects.equals(this.appSecret, applicationWithDeployment.appSecret) &&
        Objects.equals(this.appId, applicationWithDeployment.appId) &&
        Objects.equals(this.appName, applicationWithDeployment.appName) &&
        Objects.equals(this.deployment, applicationWithDeployment.deployment)&&
        Objects.equals(this.additionalProperties, applicationWithDeployment.additionalProperties);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationWithDeployment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationWithDeployment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationWithDeployment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationWithDeployment.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationWithDeployment>() {
           @Override
           public void write(JsonWriter out, ApplicationWithDeployment value) throws IOException {
 ...
 /**
  * Create an instance of ApplicationWithDeployment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicationWithDeployment
  * @throws IOException if the JSON string is invalid with respect to ApplicationWithDeployment
  */
  public static ApplicationWithDeployment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationWithDeployment.class);
  }

 /**
  * Convert an instance of ApplicationWithDeployment to an JSON string
  *
  * @return JSON string
  */
