...
public class ContainerPort {
  ...
  public ContainerPort transportType(TransportType transportType) {
  ...
  **/
   ...
   * @return the ContainerPort instance itself
   */
  public ContainerPort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transportType, containerPort.transportType) &&
        Objects.equals(this.port, containerPort.port) &&
        Objects.equals(this.name, containerPort.name)&&
        Objects.equals(this.additionalProperties, containerPort.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transportType, port, name, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContainerPort
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContainerPort.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContainerPort>() {
           ...
           public ContainerPort read(JsonReader in) throws IOException {
             ...
             ContainerPort instance = thisAdapter.fromJsonTree(jsonObj);
