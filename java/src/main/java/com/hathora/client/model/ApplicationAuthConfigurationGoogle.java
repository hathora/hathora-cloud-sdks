...
public class ApplicationAuthConfigurationGoogle {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApplicationAuthConfigurationGoogle
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationAuthConfigurationGoogle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
