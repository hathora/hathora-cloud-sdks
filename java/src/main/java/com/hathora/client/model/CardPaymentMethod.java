...
public class CardPaymentMethod {
  ...
  public CardPaymentMethod last4(String last4) {
  ...
  **/
  ...
  public CardPaymentMethod brand(CardBrand brand) {
  ...
  **/
   ...
   * @return the CardPaymentMethod instance itself
   */
  public CardPaymentMethod putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.last4, cardPaymentMethod.last4) &&
        Objects.equals(this.brand, cardPaymentMethod.brand)&&
        Objects.equals(this.additionalProperties, cardPaymentMethod.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(last4, brand, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardPaymentMethod
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardPaymentMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardPaymentMethod is not found in the empty JSON string", CardPaymentMethod.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CardPaymentMethod>() {
           ...
           public CardPaymentMethod read(JsonReader in) throws IOException {
             ...
             CardPaymentMethod instance = thisAdapter.fromJsonTree(jsonObj);
