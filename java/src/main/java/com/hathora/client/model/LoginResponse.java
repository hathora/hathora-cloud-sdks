...
public class LoginResponse {
  ...
  **/
   ...
   * @return the LoginResponse instance itself
   */
  public LoginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, loginResponse.token)&&
        Objects.equals(this.additionalProperties, loginResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoginResponse>() {
           ...
           public LoginResponse read(JsonReader in) throws IOException {
             ...
             LoginResponse instance = thisAdapter.fromJsonTree(jsonObj);
