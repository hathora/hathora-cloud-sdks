 ...
 */
@JsonAdapter(BuildStatus.Adapter.class)
public enum BuildStatus {
  ...
  public static class Adapter extends TypeAdapter<BuildStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final BuildStatus enumeration) throws IOException {
    ...
    public BuildStatus read(final JsonReader jsonReader) throws IOException {
      ...
      return BuildStatus.fromValue(value);
    }
  }
}
